...
MIGRATION_MODULES = {"sites": "root.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                # ¿?
                "root.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Rodolfo""", "la.bodega.services@gmail.com")]
